...
err_no_arg() {
    ...
    run_test "./gaussian_blur_serial"

    local line_array=()
    line_array+=("$(select_line "${STDERR}" "1")")
    line_array+=("Return code: '${RET}'")
    local corr_array=()
    corr_array+=("Usage: ./gaussian_blur_serial <input_file> <output_file> <sigma>")
...
err_no_file() {
    ...
    run_test "./gaussian_blur_serial" doesntexist doesntexist_1 1
...
err_inval_pgm_p5() {
    ...
    run_test "./gaussian_blur_serial" "<(echo -e \"not PGM\")" toto_1 1
...
err_inval_pgm_dim() {
    ...
    run_test "./gaussian_blur_serial" "<(echo -e \"P5\n2\n\")" toto_1 1
...
err_inval_sigma_big() {
    ...
    run_test "./gaussian_blur_serial" "${REF_IMG_DIR}/city_256.pgm" city_256_45.pgm 45
...
err_inval_sigma_toto() {
    ...
    run_test "./gaussian_blur_serial" "${REF_IMG_DIR}/city_256.pgm" city_256_45.pgm toto
...
## Validation serial (city_256 sigma of 2.3)
...
## Validation serial (lenna_512 sigma of 8.6)
...
## Validation serial (gentilhomme_1024 sigma of 4.2)
...
## Validation serial (ucd_pavilion_15mp sigma of 1)
